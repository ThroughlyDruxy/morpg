 ...
 * @extends {Actor}
 */
export class MOActor extends Actor {
   ...
   */
  get isTemplate() {
    return !!this.getFlag("foundryvtt-marching-order", "isTemplate");
  }
  ...
  getRollData() {
    ...
    const shorthand = game.settings.get("foundryvtt-marching-order", "macroShorthand");
