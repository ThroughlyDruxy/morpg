...
morpg.sheet = {
  ...
  position: {
    notInMarchingOrder: 'morpg.sheet.position.notInParty',
    one: 'morpg.sheet.position.one',
    two: 'morpg.sheet.position.two',
    three: 'morpg.sheet.position.three',
    four: 'morpg.sheet.position.four',
    five: 'morpg.sheet.position.five',
  },
};
